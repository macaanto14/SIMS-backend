...
export class CompleteMigration1700000000001 implements MigrationInterface {
  name = 'CompleteMigration1700000000001';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Add all foreign key constraints with conditional checks
    const foreignKeys = [
      {
    ...
    // Create indexes for better performance (conditionally)
    const indexes = [
